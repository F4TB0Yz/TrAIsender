...
import 'package:traisender/data/shared/services/notification_service.dart';
import 'package:traisender/presentation/shared/controllers/tray_controller.dart';
  ...
  Future<void> start(StatusController statusController) async {
    try {
      await dotenv.load(fileName: ".env").catchError((e) {
        dev.log('DotEnv load error: $e', name: 'AppBootstrap');
      });
      ...
      transcription.init().catchError(
        (e) => dev.log('Whisper init error: $e', name: 'AppBootstrap'),
      );
      gemini.init().catchError(
        (e) => dev.log('Gemini init error: $e', name: 'AppBootstrap'),
      );
      ...
      dev.log('Critical initialization error: $e', name: 'AppBootstrap');
    }
  }
}
