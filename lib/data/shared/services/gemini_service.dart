...
class GeminiService {
  ...
  Future<void> init() async {
    ...
    if (apiKey == null || apiKey.isEmpty) {
      dev.log(
        'Advertencia: GEMINI_API_KEY no encontrada en .env',
        name: 'GeminiService',
      );
      return;
    }
    ...
    try {
      ...
      _isInitialized = true;
      dev.log('Gemini Service inicializado.', name: 'GeminiService');
    } catch (e) {
      dev.log('Error al inicializar Gemini: $e', name: 'GeminiService');
    }
  }
...
''';
    ...
    for (var attempt = 0; attempt < _retryDelays.length; attempt++) {
      try {
        ...
        dev.log(
          'Error en Gemini (summarize): ${error.raw}',
          name: 'GeminiService',
        );
